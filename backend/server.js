...
const { startRenderWorker, stopRenderWorker } = require("./workers/render.worker");
  ...
  server.close(
    async (serverError) => {
      ...
      try {
        ...
        console.error(
          "[SERVER] Socket.IO shutdown error:",
          error
        );
      }
      ...
      try {
        ...
        console.error(
          "[SERVER] Render worker shutdown error:",
          error
        );
      }
    ...
    try {
      ...
      server.listen(
        ...
        () => {
          ...
          console.log(
            `Allowed clients: ${CLIENT_URLS.join(
              ", "
            )
            }`
          );
